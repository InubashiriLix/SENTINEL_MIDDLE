...
#ifndef HERO_MSGS__MSG__DETAIL__AUTO_AIM__STRUCT_HPP_
#define HERO_MSGS__MSG__DETAIL__AUTO_AIM__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__hero_msgs__msg__AutoAIM __attribute__((deprecated))
#else
# define DEPRECATED__hero_msgs__msg__AutoAIM __declspec(deprecated)
#endif
...
struct AutoAIM_
{
  ...
  // pointer types
  using RawPtr =
    hero_msgs::msg::AutoAIM_<ContainerAllocator> *;
  using ConstRawPtr =
    const hero_msgs::msg::AutoAIM_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<hero_msgs::msg::AutoAIM_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<hero_msgs::msg::AutoAIM_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      hero_msgs::msg::AutoAIM_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<hero_msgs::msg::AutoAIM_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<hero_msgs::msg::AutoAIM_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<hero_msgs::msg::AutoAIM_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<hero_msgs::msg::AutoAIM_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__hero_msgs__msg__AutoAIM
    std::shared_ptr<hero_msgs::msg::AutoAIM_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__hero_msgs__msg__AutoAIM
    std::shared_ptr<hero_msgs::msg::AutoAIM_<ContainerAllocator> const>
...
using AutoAIM =
  hero_msgs::msg::AutoAIM_<std::allocator<void>>;
...
#endif  // HERO_MSGS__MSG__DETAIL__AUTO_AIM__STRUCT_HPP_
