...
class Metaclass_ResetMotorPosition_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('hero_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ResetMotorPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hero_msgs.srv.ResetMotorPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from hero_msgs.srv import _reset_motor_position
...
class ResetMotorPosition(metaclass=Metaclass_ResetMotorPosition):
    from hero_msgs.srv._reset_motor_position import ResetMotorPosition_Request as Request
    from hero_msgs.srv._reset_motor_position import ResetMotorPosition_Response as Response
