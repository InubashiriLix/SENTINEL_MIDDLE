...
{
  new (message_memory) vision_msgs::msg::AutoaimState(_init);
}

void AutoaimState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vision_msgs::msg::AutoaimState *>(message_memory);
  typed_message->~AutoaimState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember AutoaimState_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(vision_msgs::msg::AutoaimState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs::msg::AutoaimState, autoaim_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs::msg::AutoaimState, target_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AutoaimState_message_members = {
  ...
  3,  // number of fields
  sizeof(vision_msgs::msg::AutoaimState),
...
{
  return &::vision_msgs::msg::rosidl_typesupport_introspection_cpp::AutoaimState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vision_msgs, msg, AutoaimState)() {
  return &::vision_msgs::msg::rosidl_typesupport_introspection_cpp::AutoaimState_message_type_support_handle;
}
