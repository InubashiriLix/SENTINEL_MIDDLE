...
bool hero_msgs__msg__dual_loop_pid_with_filter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hero_msgs.msg._dual_loop_pid_with_filter.DualLoopPIDWithFilter", full_classname_dest, 62) == 0);
  }
  hero_msgs__msg__DualLoopPIDWithFilter * ros_message = _ros_message;
  {  // header
...
PyObject * hero_msgs__msg__dual_loop_pid_with_filter__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hero_msgs.msg._dual_loop_pid_with_filter");
