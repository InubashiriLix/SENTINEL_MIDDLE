...
class Metaclass_VisionModeSwitch(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hero_msgs.srv.VisionModeSwitch')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from hero_msgs.srv import _vision_mode_switch
...
class VisionModeSwitch(metaclass=Metaclass_VisionModeSwitch):
    from hero_msgs.srv._vision_mode_switch import VisionModeSwitch_Request as Request
    from hero_msgs.srv._vision_mode_switch import VisionModeSwitch_Response as Response
