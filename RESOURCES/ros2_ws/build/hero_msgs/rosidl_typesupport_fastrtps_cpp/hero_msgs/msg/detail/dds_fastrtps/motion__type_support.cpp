...
#include "hero_msgs/msg/detail/motion__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hero_msgs::msg::Motion;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hero_msgs::msg::Motion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hero_msgs::msg::Motion *>(
    untyped_ros_message);
...
{
  return &hero_msgs::msg::typesupport_fastrtps_cpp::_Motion__handle;
}
