...
#include "hero_msgs/msg/detail/dual_loop_pid_with_filter__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hero_msgs::msg::DualLoopPIDWithFilter & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hero_msgs::msg::DualLoopPIDWithFilter & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hero_msgs::msg::DualLoopPIDWithFilter;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hero_msgs::msg::DualLoopPIDWithFilter *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hero_msgs::msg::DualLoopPIDWithFilter *>(
    untyped_ros_message);
...
{
  return &hero_msgs::msg::typesupport_fastrtps_cpp::_DualLoopPIDWithFilter__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hero_msgs, msg, DualLoopPIDWithFilter)() {
  return &hero_msgs::msg::typesupport_fastrtps_cpp::_DualLoopPIDWithFilter__handle;
}
