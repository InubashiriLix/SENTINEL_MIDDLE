...
#include "hero_msgs/srv/detail/vision_mode_switch__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hero_msgs::srv::VisionModeSwitch_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hero_msgs::srv::VisionModeSwitch_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hero_msgs::srv::VisionModeSwitch_Request *>(
    untyped_ros_message);
...
{
  return &hero_msgs::srv::typesupport_fastrtps_cpp::_VisionModeSwitch_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = hero_msgs::srv::VisionModeSwitch_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hero_msgs::srv::VisionModeSwitch_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hero_msgs::srv::VisionModeSwitch_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hero_msgs::srv::typesupport_fastrtps_cpp::_VisionModeSwitch_Response__handle;
}
...
{
  return &hero_msgs::srv::typesupport_fastrtps_cpp::_VisionModeSwitch__handle;
}
