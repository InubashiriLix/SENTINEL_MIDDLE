...
#ifndef HERO_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__TRAITS_HPP_
#define HERO_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__TRAITS_HPP_
...
inline void to_yaml(
  const hero_msgs::msg::DualLoopPIDWithFilter & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hero_msgs::msg::DualLoopPIDWithFilter & msg)
{
  return hero_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<hero_msgs::msg::DualLoopPIDWithFilter>()
{
  return "hero_msgs::msg::DualLoopPIDWithFilter";
}

template<>
inline const char * name<hero_msgs::msg::DualLoopPIDWithFilter>()
{
  return "hero_msgs/msg/DualLoopPIDWithFilter";
}

template<>
struct has_fixed_size<hero_msgs::msg::DualLoopPIDWithFilter>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<hero_msgs::msg::DualLoopPIDWithFilter>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<hero_msgs::msg::DualLoopPIDWithFilter>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // HERO_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__TRAITS_HPP_
