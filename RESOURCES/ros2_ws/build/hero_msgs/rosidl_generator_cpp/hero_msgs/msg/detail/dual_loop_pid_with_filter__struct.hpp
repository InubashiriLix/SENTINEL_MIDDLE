...
#ifndef HERO_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__STRUCT_HPP_
#define HERO_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__hero_msgs__msg__DualLoopPIDWithFilter __attribute__((deprecated))
#else
# define DEPRECATED__hero_msgs__msg__DualLoopPIDWithFilter __declspec(deprecated)
#endif
...
struct DualLoopPIDWithFilter_
{
  ...
  // pointer types
  using RawPtr =
    hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> *;
  using ConstRawPtr =
    const hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__hero_msgs__msg__DualLoopPIDWithFilter
    std::shared_ptr<hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__hero_msgs__msg__DualLoopPIDWithFilter
    std::shared_ptr<hero_msgs::msg::DualLoopPIDWithFilter_<ContainerAllocator> const>
...
using DualLoopPIDWithFilter =
  hero_msgs::msg::DualLoopPIDWithFilter_<std::allocator<void>>;
...
#endif  // HERO_MSGS__MSG__DETAIL__DUAL_LOOP_PID_WITH_FILTER__STRUCT_HPP_
