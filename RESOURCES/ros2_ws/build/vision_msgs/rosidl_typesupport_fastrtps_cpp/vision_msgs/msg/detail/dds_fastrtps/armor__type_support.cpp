...
#include "vision_msgs/msg/detail/armor__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vision_msgs::msg::Point &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  vision_msgs::msg::Point &);
...
cdr_serialize(
  const vision_msgs::msg::Armor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs::msg::Armor & ros_message)
{
  // Member: color
  cdr >> ros_message.color;
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vision_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Point(
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs::msg::Armor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_msgs::msg::Armor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_msgs::msg::Armor *>(
    untyped_ros_message);
...
{
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_msgs, msg, Armor)() {
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
