...
#include "vision_msgs/msg/detail/armor__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_msgs/msg/detail/point__functions.h"  // points

// forward declare type support functions
size_t get_serialized_size_vision_msgs__msg__Point(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_vision_msgs__msg__Point(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_msgs, msg, Point)();


using _Armor__ros_msg_type = vision_msgs__msg__Armor;
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vision_msgs, msg, Point
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      vision_msgs__msg__Point__Sequence__fini(&ros_message->points);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vision_msgs__msg__Point(
...
static uint32_t _Armor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__Armor(
  ...
  size_t current_alignment)
{
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vision_msgs__msg__Point(
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs__msg__Armor;
    is_plain =
      (
...
static size_t _Armor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_msgs__msg__Armor(
